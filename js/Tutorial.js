...
{	
	create: function()
	{
		...
		// plan.gas = this.game.add.group();
//         var temp = plan.gas.create(750, 200, 'gasParticleOrange');
//         temp.kill();
